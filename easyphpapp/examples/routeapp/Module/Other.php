 ...
 *
 */
class Module_Other extends Ea_Module_Abstract
{
	...
	public function actionIndex()
	{
		...
		$this->getPage()->add('Current route (other) : '.$this->getRouter()->getTargetModule().'::'.$this->getRouter()->getTargetAction());
		...
		$route=$this->getRouter()->getRoute(null, null, 'index');
		$this->getPage()->add(new Ea_Layout_Link($route, 'index::<default action>'));
		$this->getPage()->add(new Ea_Layout_Single('br'));
