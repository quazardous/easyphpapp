 ...
 * 
 */
class Ea_Layout_Grid extends Ea_Layout_Table
{
	 ...
	 * 
	 * @param Iterator $records
	 * @param Ea_Layout_Grid_Populate_Adapter_Interface $adapter
	 */
	...
	public function addColumn(Ea_Layout_Record_Adapter_Interface $column, $content=null, $idCol=null, $mode='append', $seekCol=null)
	{
		...
		{
			throw new Ea_Layout_Grid_Exception("$idCol : column id already used");
		}
	 ...
	 * 
	 * @param int $i
	 * @return Ea_Layout_Grid_Populate_Adapter_Interface
	 */
