 ...
 */
class Ea_Model_Layout_Record_Adapter_Enum extends Ea_Layout_Record_Adapter_Field implements Ea_Model_Layout_Record_Adapter_Interface
{
	public function __construct($column, Ea_Model_Layout $model)
	{
		parent::__construct($column, $model->getColumnEnum($column));
